...
input_base_path = '/mnt/disks/my_disk1/my_data/cs236_project/dreambooth/' + tinv_obj + '/'
...
prompts_filename = {
    ...
    '_fireman.png': (tinv_token + 'in a firman outfit'),
    '_doctor.png': (tinv_token + 'in a doctor outfit'),
    '_swimmer.png': (tinv_token + 'in a swimmer outfit'),
    '_painter.png': (tinv_token + 'in a painter outfit'),
    '_plumber.png': (tinv_token + 'as a plumber'),
    ...
    '_crimson.png': ('a crimson colored ' + tinv_token),
    '_orange.png': ('an orange colored ' + tinv_token),
    '_black.png': ('a black colored ' + tinv_token + 'in white background'),
    '_turqoise.png': ('an turqoise colored ' + tinv_token),
    '_white.png': ('a white colored ' + tinv_token + 'in black background'),
